...
function createDefaultAgentState(agentId) {
  ...
  return {
    ...
    orders: [
      { id: 'order-1', amount: 150, status: 'completed', source: 'store', created_date: now, package_name: 'Data bundle' },
      { id: 'order-2', amount: 75, status: 'pending', source: 'store', created_date: now, package_name: 'Data bundle' },
    ],
    withdrawals: [
      { id: 'wd-1', amount: 25, method: 'momo', account_info: '0244000000', status: 'paid', created_date: now },
      { id: 'wd-2', amount: 15, method: 'bank', account_info: '123456789', status: 'pending', created_date: now },
    ],
  };
}
